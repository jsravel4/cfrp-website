...
3. HTTP API.
Cet outil est pour les développeurs. Il offre accès à une copie complète des données dans un format JSON, avec la possibilité de recherche, ordonnement, filtration et pagination en temps réel. Une demande OPTIONS envoyée à http://api.cfregisters.org/ fournit les points de terminaison; Une demande OPTIONS envoyée à chaque point de terminaison fournit sa structure. De la documentation est disponible <a href="https://github.com/begriffs/postgrest/wiki/Routing">ici</a>.
